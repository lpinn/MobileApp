            ...
            <View style={styles.button2StackRow}>
              <View style={styles.button2Stack}>
                <TouchableOpacity style={styles.button2}>
                  ...
                  <ImageBackground
                    source={require("./src/assets/images/coffee.jpg")}
                    resizeMode="cover"
                    style={styles.image}
              ...
              <TouchableOpacity style={styles.button3}>
                  ...
                  <ImageBackground
                    source={require("./src/assets/images/coffee2.jpg")}
                    resizeMode="cover"
                    style={styles.image}
                    imageStyle={styles.image_imageStyle}
                  >
            ...
            <TouchableOpacity style={styles.button6}>
              ...
              >
                ...
                <View style={styles.rect86}>
                  <Text style={styles.text27}>FUNDRAISE FOR YOUR CAUSE AND OURS</Text>
                </View>
              </ImageBackground>
            </TouchableOpacity>
          </View>
